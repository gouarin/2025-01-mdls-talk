...
```{=html}
<video data-autoplay src="figures/videos/identify_0000.mp4" />
```

## Identify the different types of cells

```{=html}
<video data-autoplay src="figures/videos/identify_0001.mp4" />
```

## Identify the different types of cells

```{=html}
<video data-autoplay src="figures/videos/identify_0002.mp4" />
```

## Identify the different types of cells

```{=html}
<video data-autoplay src="figures/videos/identify_0003.mp4" />
```
...
<video data-autoplay src="figures/videos/projection.mp4" />
...
<video data-autoplay loop="true" src="figures/videos/ignition_Re1000.mov" />
...
::::{.col-4}
<video data-autoplay loop="true" src="figures/videos/ink.mp4" />
::::
::::{.col}
![](figures/human.png)
::::
...
:::{.row .align-items-center}
::::{.col-4}
<video data-autoplay loop="true" src="figures/videos/bubble.mp4" />::::
::::{.col}
![](figures/plasma.png)
::::
:::
