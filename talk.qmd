...
footer: Maison de la Simulation - <img width="5%" src="figures/by.png"/> - 21 January 2025
---
...
![](figures/logo_HPC@Maths.jpg){width=70%}
::::
:::
::::
...
:::{.notes}
As we have seen, calculating the flow at the finest level is crucial to obtaining good error estimates. But how does this work in practice?
...
## MRA $\epsilon = 1e-2$, $\underline{\ell} = 1$, $\bar{\ell} = 12$ without portion {.fs-6}

:::{.text-center}
<video data-autoplay width="80%" src="videos/burgers/MRA_upwind_without_portion-min_1-max_12-eps_0.01-reg_0.mp4" />
:::

## MRA $\epsilon = 1e-3$, $\underline{\ell} = 1$, $\bar{\ell} = 12$ without portion {.fs-6}

:::{.text-center}
<video data-autoplay width="80%" src="videos/burgers/MRA_upwind_without_portion-min_1-max_12-eps_0.001-reg_0.mp4" />
:::

## MRA $\epsilon = 1e-4$, $\underline{\ell} = 1$, $\bar{\ell} = 12$ without portion {.fs-6}

:::{.text-center}
<video data-autoplay width="80%" src="videos/burgers/MRA_upwind_without_portion-min_1-max_12-eps_0.0001-reg_0.mp4" />
:::

## MRA $\epsilon = 1e-2$, $\underline{\ell} = 1$, $\bar{\ell} = 12$ with portion {.fs-6}

:::{.text-center}
<video data-autoplay width="80%" src="videos/burgers/MRA_upwind_with_portion-min_1-max_12-eps_0.01-reg_0.mp4" />
:::

## MRA $\epsilon = 1e-3$, $\underline{\ell} = 1$, $\bar{\ell} = 12$ with portion {.fs-6}

:::{.text-center}
<video data-autoplay width="80%" src="videos/burgers/MRA_upwind_with_portion-min_1-max_12-eps_0.001-reg_0.mp4" />
:::

## MRA $\epsilon = 1e-4$, $\underline{\ell} = 1$, $\bar{\ell} = 12$ with portion {.fs-6}

:::{.text-center}
<video data-autoplay width="80%" src="videos/burgers/MRA_upwind_with_portion-min_1-max_12-eps_0.0001-reg_0.mp4" />
:::
